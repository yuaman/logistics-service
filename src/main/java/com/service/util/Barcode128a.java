...
/**
 * 
 * @ClassName BarCode128a
 * @Description 圆通条形码生成类 
 *  * @author 于霆霖
 * @Date 2016年12月2日 下午3:19:31
 * @version 1.0.0
 */
public class Barcode128a {
	private static Logger log = LoggerFactory.getLogger(Barcode128a.class);
	...
	*/
	public static String getCode(String barCode) {
		...
		int _Examine = 103; // 首位
		// 编码不能是奇数    ？？？EMS返回为九位。为何不能总厂位数不能为奇？待议
...
//			return "";
	...
	*/
	...
	public static void main(String[] args) throws Exception{
		getCode128APicture("909751806719","billNo_"+"909751806710"+".jpg");
	}
	 ...
	 */
	public static void getCode128APicture(String barCode, String path) {
//		System.out.println("barcode================"+barCode);;
		String barString = getCode(barCode);
//        System.out.println("变参二进制编码之后==========="+barString);
		drawCode128A(barString, 30, path);
	}
	...
	public static void drawCode128A(String barString, int height, String path){
		try{
